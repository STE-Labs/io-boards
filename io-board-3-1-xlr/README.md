# 3.1 Channel IO Board for XLR
[Home](../README.md)

3 input and 1 output XLR board for routing audio signals
...
- 3 input XLR connections with indicator LEDs
- 1 output XLR connection with indicator LED
...
|CONNECTOR|6|Neutrik NC3 MAV|XLR Input connectors|
|CONNECTOR|2|Neutrik NC3 FAA V2|XLR Output connectors|
