# 5.0 Channel IO Board for XLR
[Home](../README.md)

5 input and 0 output XLR board for routing audio signals
...
- 5 input XLR connections with indicator LEDs
...
|CONNECTOR|10|Neutrik NC3 MAV|XLR Input connectors|
